...
| 5 | Logs / labels / env | Fuite de secrets | Réédaction systématique des valeurs sensibles en sortie |
...
| 9 | Streams (logs/events) | Déni de service (flux illimités) | Limites/backpressure ; délais et bornes de taille |
...
- Création/suppression de conteneurs, `exec`, logs, stats, images, volumes,
  réseaux, événements : non implémentés.
- Compose, TUI, API, Web : non implémentés (voir [ADR](adr/)).
